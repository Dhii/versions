    ...
    public function getVersionSpecs(): array
    {
        return [
            ...
            [
                ...
                random_int(1, 99),
                random_int(1, 999),
                ['alpha1', random_int(1, 99), random_int(1, 999)],
                [],
                null,
            ],
            [
                ...
                random_int(1, 999),
                [],
                [uniqid('wake'), random_int(1, 999), uniqid('neo')],
                null,
            ],
            [
                random_int(1, 9),
                random_int(1, 99),
                random_int(1, 999),
                ['beta2', random_int(1, 99), random_int(1, 999)],
            ...
            [
                ...
                '',
                [],
                [uniqid('foo'), random_int(1, 999), uniqid('bar')],
